...
c     author: Pengjia Zhu
      ...
      subroutine GET_GN(X,Q2,G1TMP,G2TMP)
      implicit none
      integer DB_N,DB_NW
      ...
      integer i,j
      common/DBN/DB_NW,db_W,db_Q2GeV,db_g1,db_g2
...
c      write(g12file,"(A11I4A4)") "data/WQg12_",Ebeam,".txt"
      gfn='/var/phy/project/mepg/xy33/TMD/pyg2pasym-master/WQg12_n.txt'
